...
public class Follower extends Learner{
    ...
    protected void processPacket(QuorumPacket qp) throws Exception{
        switch (qp.getType()) {
        case Leader.PING:
            LOG.info("@hkR-processPacket PING message");
            ping(qp);            
            break;
        case Leader.PROPOSAL:
            LOG.info("@hkR-Follower processPacket PROPOSAL message");
            ...
            break;
        case Leader.COMMIT:
            LOG.info("@hkR-Follower processPacket COMMIT message");
            fzk.commit(qp.getZxid());
            break;
            
        case Leader.COMMITANDACTIVATE:
            LOG.info("@hkR-Follower processPacket COMMITANDACTIVATE message");
        ...
        case Leader.REVALIDATE:
            ...
            break;
        case Leader.SYNC:
            LOG.info("@hkR-Follower processPacket SYNC message");
            fzk.sync();
            break;
        default:
