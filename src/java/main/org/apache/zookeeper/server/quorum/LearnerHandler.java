...
public class LearnerHandler extends ZooKeeperThread {
    ...
    private void sendPackets() throws InterruptedException {
        ...
        while (true) {
            try {
                ...
                LOG.info("@hkS-Leader sendPackets()  message "+p.getType());
    ...
    public void run() {
        try {
            ...
            LOG.info("@hkS-LearnerHandler needSnap is "+needSnap);
            ...
            if (needSnap) {
                ...
                try {
                    ...
                    bufferedOutput.flush();
                    LOG.info("@hkS-LearnerHandler needSnap Leader.SNAP");
            ...
            while (true) {
                ...
                switch (qp.getType()) {
                case Leader.ACK:
                    LOG.info("@hkR-LearnerHandler received ACK message");
                    ...
                    break;
                case Leader.PING:
                    LOG.info("@hkR-LearnerHandler received PING message");
                    // Process the touches
                ...
                case Leader.REVALIDATE:
                    ...
                    break;
                case Leader.REQUEST:
                    LOG.info("@hkR-LearnerHandler received REQUEST message");
